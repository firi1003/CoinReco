...
| 단계 | 대분류 | 상세 작업 | 담당자 | 기간 |
|-----|--------|-----------|--------|------|
| **1. 기획/설계** | 요구사항 분석 | 기능 명세서 작성, ERD 설계, WBS 작성 | 오재우 | 2025-12-22 |
| | 디자인 | UI/UX 와이어프레임 설계 | 오재우 | 2025-12-22 |
| **2. 데이터** | 데이터 수집 | `coins_data.csv` 완성 (201개 코인 정보) | 오재우 | 2025-12-22 |
| | 데이터 정제 | `coingecko_id` 매핑, 시총/발행량 데이터 확보 | 오재우 | 2025-12-22 |
| **3. 백엔드** | 모델 구현 | `models.py` 정의 및 DB 마이그레이션 | 오재우 | 2025-12-22 |
| | 핵심 로직 | 추천 알고리즘 개발 (위험도/유행 민감도 반영) | 오재우 | 2025-12-22 |
| | 회원 시스템 | 가입/로그인/투자 성향 설정 2단계 분리 | 오재우 | 2025-12-22 |
| | API 연동 | CoinGecko API(시세), GPT API(분석) 연동 | 오재우 | 2025-12-22 |
...
| **5. 테스트/통합** | 통합 테스트 | 기능 버그 수정 및 데이터 검증 | 오재우 | 2025-12-24 ~ 2025-12-25 |
| **6. 마감** | 최종 마감 | PPT 작성 및 최종 문서 정리 | 오재우 | 2025-12-26 |
